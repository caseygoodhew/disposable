...
-- Author :       Casey
--
-- Date Created : Wednesday, July 02, 2014 16:06:53
...
CREATE TABLE DISPOSABLE.SYSTEM_USER(
    ...
    EMAIL          VARCHAR2(200)    NOT NULL
                   CONSTRAINT CHK_SYSTEM_USER_EMAIL CHECK (EMAIL =TRIM(EMAIL)),
    LOWER_EMAIL    VARCHAR2(200)    NOT NULL
                   CONSTRAINT CHK_SYSTEM_USER_LOWER_EMAIL CHECK (LOWER_EMAIL = LOWER(TRIM(LOWER_EMAIL))),
...
;
-- 
-- INDEX: DISPOSABLE.UK_LOWER_EMAIL 
--

CREATE UNIQUE INDEX DISPOSABLE.UK_LOWER_EMAIL ON DISPOSABLE.SYSTEM_USER(LOWER_EMAIL)
;
-- 
-- TABLE: DISPOSABLE.ACE 
--

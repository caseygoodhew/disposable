...
namespace Disposable.Web.Views.Account
{
    ...
    public partial class Login : System.Web.Mvc.WebViewPage<Disposable.Web.Models.LoginModel>
    {
        public Login()
        {
        }
...
WriteLiteral("                ");
           ...
           Write(Html.TextBoxFor(m => m.UserName, new { autocomplete="off" }));
...
WriteLiteral("                ");
           ...
           Write(Html.PasswordFor(m => m.Password, new { autocomplete="off" }));

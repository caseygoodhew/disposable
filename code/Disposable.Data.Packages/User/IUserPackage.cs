...
namespace Disposable.Data.Packages.User
{
    ...
    public interface IUserPackage : IPackage
    {
        ...
        /// <returns>The <see cref="IStoredMethodInstance"/>.</returns>
        IStoredMethodInstance AuthenticateUserProcedure(string email, string password);
        ...
        /// <returns>The <see cref="IStoredMethodInstance"/>.</returns>
        IStoredMethodInstance CreateUserProcedure(string email, string password, bool isApproved);
        ...
        IStoredMethodInstance GetUserProcedure(string username);
    }
}
